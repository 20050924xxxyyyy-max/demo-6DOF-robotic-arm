...
constexpr float MAX_J0_V = 3.0;  // rad/s
constexpr float MAX_J1_V = 2.5;  // rad/s
constexpr float MAX_J2_V = 2.5;  // rad/s
constexpr float MAX_J3_V = 9;    // rad/s
constexpr float MAX_J4_V = 9;    // rad/s
constexpr float MAX_J5_V = 3;    // rad/s

constexpr float MAX_J0_T = 120;  // N·m
constexpr float MAX_J1_T = 150;  // N·m
constexpr float MAX_J2_T = 120;  // N·m
constexpr float MAX_J3_T = 10;   // N·m
constexpr float MAX_J4_T = 10;   // N·m
constexpr float MAX_J5_T = 10;   // N·m

constexpr float T = 0.001;  // PID控制周期, 单位: s

inline sp::PID j0_speed_pid(T, 40, 20, 0.001, MAX_J0_T, 0.5);
inline sp::PID j1_speed_pid(T, 15, 20, 0.001, MAX_J1_T, 0.5);
inline sp::PID j2_speed_pid(T, 15, 20, 0.001, MAX_J2_T, 2.0);
inline sp::PID j3_speed_pid(T, 1.2, 20, 0.001, MAX_J3_T, 0.5);
...
//可以整周转动的转劣弧
inline sp::PID j0_pos_pid(T, 30, 0, 0, MAX_J0_V, MAX_J0_V, 1.0f, true);
