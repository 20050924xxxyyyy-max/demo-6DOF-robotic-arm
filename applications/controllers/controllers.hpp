...
inline sp::DM_Motor motor_j5(0x05, 0x15, 3.141593, 30, 10, true);

constexpr float theta[6] = {sp::SP_PI, sp::SP_PI, 0, sp::SP_PI, sp::SP_PI / 2, 0};
constexpr float d[6] = {0, 0, 0, 0.234, 0, 0};
constexpr float a[6] = {0, 0.2133, 0.04, 0, 0.03, 0};
