...
constexpr float MID_J0 = 1.33693;           //rad
constexpr float MID_J1 = -0.38261;          //rad
constexpr float MID_J2 = -1.44498;          //rad
...
inline JointMotorController j1_controller(
  MID_J1, MIN_J1, MAX_J1, false, motor_j1, j1_pos_pid, j1_speed_pid);
inline JointMotorController j2_controller(
  MID_J2, MIN_J2, MAX_J2, false, motor_j2, j2_pos_pid, j2_speed_pid);
